        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    @forelse($products as $product)
                        <div
                            class="border border-gray-200 rounded-lg overflow-hidden shadow hover:shadow-md transition duration-300 bg-white text-gray-800">
                            ...
                            <div class="p-4">
                                ...
                                <button
                                    class="w-full bg-pink-600 text-white py-2 px-4 rounded hover:bg-pink-700 transition">
                                    Add to Cart
                                </button>
                            </div>
                        </div>
